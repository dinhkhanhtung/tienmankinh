...
export default function LoginPage() {
  ...
  return (
    <div className="flex-1 flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-8 bg-background max-w-md mx-auto w-full">
      {/* Brand Logo */}
      <div className="text-center mb-8">
        ...
        <h1 className="text-3xl font-extrabold text-foreground tracking-tight">Tiền Mãn Kinh</h1>
      ...
      <Card className="border border-border shadow-sm rounded-2xl overflow-hidden">
        <CardHeader className="space-y-1 pb-6 bg-muted/30">
          <CardTitle className="text-xl font-bold text-center">
            {isSignUp ? "Tạo tài khoản mới" : "Chào mừng quay trở lại"}
          </CardTitle>
          <CardDescription className="text-center text-sm">
            {isSignUp
              ? "Hãy đăng ký để bắt đầu theo dõi sức khỏe cá nhân"
        ...
        <CardContent className="pt-6">
          <form onSubmit={handleEmailAuth} className="space-y-4">
            {isSignUp && (
              <div className="space-y-2">
                <Label htmlFor="name" className="text-sm font-semibold text-foreground">Họ và Tên</Label>
            ...
            <div className="space-y-2">
              <Label htmlFor="email" className="text-sm font-semibold text-foreground">Địa chỉ Email</Label>
              <div className="relative">
            ...
            <Button
              type="submit"
              className="w-full h-12 text-base font-semibold rounded-xl bg-primary text-primary-foreground hover:bg-primary/95 mt-4 transition-colors"
              disabled={loading}
            >
              {loading ? (
                <>
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-card px-3 text-muted-foreground font-semibold">Hoặc tiếp tục bằng</span>
            </div>
          </div>
          ...
          <Button
            type="button"
            variant="outline"
            className="w-full h-12 rounded-xl border-border hover:bg-muted text-foreground font-semibold text-base transition-colors"
        ...
        <CardFooter className="flex justify-center border-t border-border/50 bg-muted/10 py-4">
          <p className="text-sm text-muted-foreground font-medium">
            {isSignUp ? "Bạn đã có tài khoản?" : "Chưa có tài khoản sức khỏe?"}{" "}
            <button
